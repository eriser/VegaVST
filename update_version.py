...
def main():
  ...
  plistpath = scriptpath + "/resources/Vega-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Vega-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Vega-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Vega-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Vega-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/Vega-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/Vega.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Vega.iss",inplace=1):
